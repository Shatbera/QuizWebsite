...
-- Insert quizzes
INSERT INTO quizzes (user_id, title, description, randomize, display_type, immediate_correction)
VALUES (0, 'General Knowledge Quiz', 'Test your general knowledge.', 0, 'one_page', 0),
...
VALUES (1, 'question_response', 'What is the capital of France?'),
...
INSERT INTO answers (question_id, answer, is_correct, answer_order)
VALUES
...
INSERT INTO questions (quiz_id, question_type, question_text)
VALUES (2, 'question_response', 'What is 2+2?'),
...
INSERT INTO questions (quiz_id, question_type, question_text)
VALUES (3, 'question_response', 'What planet is known as the Red Planet?'),
...
INSERT INTO questions (quiz_id, question_type, question_text)
VALUES (1, 'multi_choice', 'Which of the following rivers is the longest?');

-- Insert answers for 'Which of the following rivers is the longest?' question
INSERT INTO answers (question_id, answer, is_correct, answer_order)
VALUES (16, 'Amazon', FALSE, 1),
       (16, 'Nile', TRUE, 2),
       (16, 'Yangtze', FALSE, 3),
       (16, 'Mississippi', FALSE, 4);

-- Insert matches for General Knowledge Quiz
INSERT INTO matches (question_id, left_match, right_match)
VALUES (3, 'France', 'Paris'),
       (3, 'Germany', 'Berlin');
...
alter table quizzes
    add column max_score int not null;
